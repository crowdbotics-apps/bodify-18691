"""
Django settings for bodify_18691 project.
...
ROOT_URLCONF = 'bodify_18691.urls'
...
WSGI_APPLICATION = 'bodify_18691.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    # 'DEFAULT_PERMISSION_CLASSES': ('rest_framework.permissions.IsAdminUser',), # because postman and swagger not working
...
if DEBUG or not (EMAIL_HOST_USER and EMAIL_HOST_PASSWORD):
    ...
    if not DEBUG:
        logging.warning("You should setup `_USERNAME` and `SENDGRID_PASSWORD` env vars to send emails.")
