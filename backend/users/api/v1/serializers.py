...
class AuthAccountProfileSerializer(serializers.ModelSerializer):
    ...
    # surname = serializers.CharField(max_length=32, required=False, allow_blank=False)
    ...
    class Meta:
        model = User
        fields = ('id', 'username', 'email', 'first_name', 'last_name', 'surname', 'phone', 'profile_picture', 'user_type',
    ...
    #     if surname == "":
    #         raise serializers.ValidationError(_('Surname is empty.'))
    #     return surname
...
class AccountSignupSerializer(serializers.ModelSerializer):
    ...
    #surname = serializers.CharField(max_length=32, required=False, allow_blank=True, allow_null=True, default=None)
    ...
    class Meta:
        model = User
        fields = ('id', 'username', 'email', 'phone', 'first_name', 'last_name', 'surname', 'profile_picture', 'password',
                  'user_type', 'profile')
        extra_kwargs = {
            'username': {
                'read_only': True,
    ...
    def create(self, validated_data):
        ...
        if 'surname' in validated_data and validated_data.get('surname') != "":
